...
class lista():
    ...
    def __next__(self):
        if self.__indice==self.__tope:
            ...
            return dato
    def instanciar(self):
        with open('C:\\Users\\users\\Documents\\Cristiannika\\SEGUNDO AÑO DE FACULTAD\\Programacion orientada a objetos\\UNIDAD 3\\ejercicio7\\personal.json', 'r') as f:
            datos = json.load(f)
    ...
    def guarda(self):
        with open('C:\\Users\\users\\Documents\\Cristiannika\\SEGUNDO AÑO DE FACULTAD\\Programacion orientada a objetos\\UNIDAD 3\\ejercicio7\\personal.json', 'w') as f:
                    datos = []
